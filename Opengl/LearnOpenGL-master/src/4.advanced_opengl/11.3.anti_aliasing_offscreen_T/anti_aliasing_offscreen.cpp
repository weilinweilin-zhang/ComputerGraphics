...
int main()
{
    ...
    glBufferData(GL_VERTEX_ARRAY, sizeof(quadVertices), &quadVertices, GL_STATIC_DRAW);
    // 坐标
    glEnableVertexAttribArray(0);
    ...
    glGenFramebuffers(GL_FRAMEBUFFER, &intermediateFBO);
    glBindFramebuffer(GL_FRAMEBUFFER, intermediateFBO);

    unsigned int screenTexture;
    glGenTextures(GL_TEXTURE_2D, &screenTexture);
